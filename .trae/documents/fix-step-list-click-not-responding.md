...
当前 [step_list_widget.py](file:///d:/Github/PY/ui/components/step_list_widget.py) 中存在的问题：
...
### 1. [PY/ui/components/step_list_widget.py](file:///d:/Github/PY/ui/components/step_list_widget.py) — 移除 setStyleSheet 调用
